...
pub fn ser_message_update_to_twl_message(ser: MessageUpdateEvent) -> Option<Message> {
    Some(Message {
        ...
        edited_timestamp: ser.edited_timestamp.map(|z| ser_timestamp_to_twl_timestamp(z)),
...
pub fn ser_message_to_twl_message(ser: SerMessage) -> Message {
    Message {
        application_id: ser.application_id.map(|x| Id::<ApplicationMarker>::new(x.get())),
        interaction: None,
        activity: None,
        application: None,
        ...
        reactions: vec![],
        reference: None,
        referenced_message: ser.referenced_message.map(|x| Box::new(ser_message_to_twl_message(*x))),
        sticker_items: vec![],
        timestamp: ser_timestamp_to_twl_timestamp(ser.timestamp),
        tts: false,
