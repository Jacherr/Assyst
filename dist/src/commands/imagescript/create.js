...
class ImageScriptCreateCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.aliases = ['ist create'];
        this.label = 'args';
        this.name = 'imagescripttag create';
        this.metadata = {
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.assyst.database.createImageScriptTag(tag, code, context.userId);
            context.editOrReply('Tag created successfully.');
        });
    }
}
exports.default = ImageScriptCreateCommand;
