...
class Edges2PornCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'edges2porn';
        this.metadata = {
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.edges2Porn(url);
...
exports.default = Edges2PornCommand;
