...
class NorthKoreaCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'northkorea';
        this.metadata = {
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.northKorea(url);
            return context.editOrReply({
                file: {
                    filename: 'northkorea.png',
                    value: res
                }
            });
        });
...
exports.default = NorthKoreaCommand;
