...
class Edges2EmojisCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'edges2emojis';
        this.metadata = {
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.edges2Emojis(url);
...
exports.default = Edges2EmojisCommand;
