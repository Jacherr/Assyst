...
class ZuckerbergCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'zuckerberg';
        this.metadata = {
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.zuckerberg(url);
...
exports.default = ZuckerbergCommand;
