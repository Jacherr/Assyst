...
class RespectsCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'respects';
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.respects(url);
            return context.editOrReply({
                file: {
                    filename: 'respects.png',
                    value: res
                }
            });
        });
...
exports.default = RespectsCommand;
