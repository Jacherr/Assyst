...
class Edges2PornGifCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'edges2porngif';
        this.metadata = {
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.edges2PornGif(url);
...
exports.default = Edges2PornGifCommand;
