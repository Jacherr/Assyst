...
class KekistanCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'kekistan';
        this.metadata = {
            description: 'Kekistan',
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.kekistan(url);
            return context.editOrReply({
                file: {
                    filename: 'kekistan.png',
                    value: res
                }
            });
        });
...
exports.default = KekistanCommand;
