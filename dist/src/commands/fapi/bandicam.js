...
class BandicamCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'bandicam';
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.bandicam(url);
            return context.editOrReply({
                file: {
                    filename: 'bandicam.png',
                    value: res
                }
            });
        });
...
exports.default = BandicamCommand;
