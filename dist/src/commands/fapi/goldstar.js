...
class GoldstarCommand extends basefapicommand_1.BaseFapiCommand {
    constructor() {
        super(...arguments);
        this.label = 'url';
        this.name = 'goldstar';
        this.metadata = {
            description: 'Goldstar',
    ...
    run(context, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.fapi.goldstar(url);
            return context.editOrReply({
                file: {
                    filename: 'goldstar.png',
                    value: res
                }
            });
        });
...
exports.default = GoldstarCommand;
